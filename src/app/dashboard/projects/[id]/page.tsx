...
import { ArrowLeft, Download, FileText, Image as ImageIcon, User, Calendar, DollarSign, Play, Zap, Target, Clock, AlertCircle, XCircle } from "lucide-react";
          ...
          >
            ...
            >
              {fields.map((field, index) => {
                ...
                // Le champ textarea prend toute la largeur
                const isTextareaField = field.field_type === 'textarea';
                ...
                return (
                  <motion.div
                    ...
                    className={`p-6 backdrop-blur-md bg-white/40 rounded-2xl border border-white/40 hover:bg-white/60 transition-all duration-300 group ${
                      isTextareaField || ['files_image', 'files_audio', 'files_document'].includes(field.field_type) ? 'md:col-span-2' : ''
                    }`}
                    variants={{
                      hidden: { y: 30, opacity: 0 },
                      visible: { y: 0, opacity: 1 }
                  ...
                  >
                    <div className="mb-4">
                      <motion.h3
                        className="font-semibold text-gray-900 group-hover:text-[#062C57] transition-colors mb-2 flex items-center"
                        initial={{ opacity: 0 }}
                        animate={{ opacity: 1 }}
                        transition={{ delay: 0.4 + index * 0.1 }}
                      >
                        <motion.span
                          className={`w-8 h-8 bg-gradient-to-br ${fieldIcon.color} rounded flex items-center justify-center text-white text-md mr-2 flex-shrink-0`}
                          animate={{
                            rotate: [0, 5, -5, 0],
                            scale: [1, 1.05, 1]
                          }}
                        ...
                        {field.field_type === 'files_image' && field.files && field.files.length > 0 ? (
                          ...
                          >
                            {field.files.map((file, fileIndex) => (
                              <motion.div
                                key={fileIndex}
                                className="aspect-square rounded-2xl overflow-hidden cursor-pointer group/img relative bg-gradient-to-br from-gray-200 to-gray-300"
                                variants={{
                              ...
                              >
                                    ...
                                    if (parent) {
                                      parent.innerHTML = `
                                        <div class="w-full h-full flex items-center justify-center bg-gradient-to-br from-[#1EB1D1]/20 to-[#062C57]/20">
                                          <svg width="40" height="40" fill="none" stroke="currentColor" viewBox="0 0 24 24" class="text-white/70">
                                ...
                                <motion.div
                                  className="absolute inset-0 bg-black/50 opacity-0 group-hover/img:opacity-100 transition-opacity duration-300 flex items-end"
                                  initial={{ opacity: 0 }}
                                ...
                                <motion.div
                                  className="absolute top-3 right-3 w-8 h-8 bg-white/20 backdrop-blur-md rounded-full flex items-center justify-center opacity-0 group-hover/img:opacity-100 transition-opacity duration-300"
                                ...
                                <motion.div
                                  className="absolute inset-0 bg-gradient-to-r from-transparent via-white/20 to-transparent opacity-0 group-hover/img:opacity-100 transform -skew-x-12 -translate-x-full group-hover/img:translate-x-full transition-all duration-700"
                                  style={{ width: "50%" }}
                                />
                              </motion.div>
                            ))}
                          ...
                          >
                            {field.files.map((file, fileIndex) => (
                              <motion.div
                                ...
                                animate={{ scale: 1, opacity: 1 }}
                                transition={{ delay: 0.4 + fileIndex * 0.1, duration: 0.5 }}
                              >
                                <div className="flex items-center space-x-6">
                                  ...
                                  <div className="flex-1">
                                    <motion.p
                                      ...
                                      animate={{ y: 0, opacity: 1 }}
                                      transition={{ delay: 0.7 + fileIndex * 0.1 }}
                                    >
                                      {file.split('/').pop()}
                                    </motion.p>
                                  </div>
                                ...
                                <motion.div
                                  ...
                                  initial={{ opacity: 0 }}
                                  animate={{ opacity: 1 }}
                                  transition={{ delay: 1 + fileIndex * 0.1 }}
                                >
                                  {[...Array(20)].map((_, i) => (
                                    <motion.div
                                      key={i}
                          ...
                          >
                            {field.files.map((file, fileIndex) => {
                              ...
                              return (
                                <motion.div
                                  key={fileIndex}
                                  className="flex items-center justify-between p-4 backdrop-blur-md bg-white/40 rounded-2xl border border-white/40 hover:bg-white/60 transition-all duration-300 group/doc cursor-pointer"
                                  variants={{
                                ...
                                >
                                  <div className="flex items-center space-x-4">
                                    ...
                                    <div>
                                      <motion.h4
                                        className="font-semibold text-gray-900 group-hover/doc:text-[#062C57] transition-colors"
                                        initial={{ opacity: 0 }}
                                        animate={{ opacity: 1 }}
                                        transition={{ delay: 0.4 + fileIndex * 0.1 }}
                                      >
                                        {file.split('/').pop()}
                                      </motion.h4>
                                      <motion.p
                                  ...
                                  <motion.div
                                    className="p-3 hover:bg-white/50 rounded-xl transition-all duration-200 text-gray-600 hover:text-[#1EB1D1] opacity-0 group-hover/doc:opacity-100"
                          ...
                          <motion.div
                            className={`text-gray-700 break-words ${
                              isTextareaField ? 'text-lg leading-relaxed' : ''
                            }`}
                            initial={{ opacity: 0 }}
                            animate={{ opacity: 1 }}
                            transition={{ delay: 0.5 + index * 0.1 }}
            ...
            >
              {[
                ...
                },
                {
                  ...
                  icon: Target,
                  color: "from-purple-400 to-violet-500",
                  action: () => window.open(`${project.company_service.company.website}`, '_blank')
                }
              ].map((action, index) => (
                <motion.button
                  key={index}
